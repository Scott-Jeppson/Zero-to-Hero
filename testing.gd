...
# TODO Have mob weights change as game progresses so stronger enemies don't
# start appearing until later
...
func _ready() -> void:
	# TODO Instead of 5 spawn location all firing at the same time
	# Have one spawn location that spawns mobs faster
